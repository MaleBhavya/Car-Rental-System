	...
	public void menu()
	{
		...
		while(true)
		{
			...
			if(choice==1)
			{
				...
				System.out.print("\n Enter the days you want to rental:");
...
public class CRS {
 ...
 Car cr1=new Car("M001", "Nano","XE", 20.0);
 Car cr2=new Car("M002","Swift", "VZi", 40.0);
 Car cr3=new Car("M003", "Honda", "Pilot", 45.0);
 Car cr4=new Car("M004", "Nissan", "Versa", 60.0);
 rs.addCar(cr1);
 rs.addCar(cr2);
 rs.addCar(cr3);
 rs.addCar(cr4);
